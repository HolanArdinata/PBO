...
public class Main {
    private static ArrayList <Alat> dataAlat = new ArrayList<>();
    private static ArrayList <Sepatu> dataSepatu  = new ArrayList<>();
    ...
    public static void main(String[] args) throws IOException{
        ...
        while (lanjutkan) {
            ...
            private static void tambahAlat() throws IOException {
                ...
                Alat alatBaru = new Alat(nama, tipe, merk, stok, harga);
