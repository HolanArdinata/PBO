        ...
        while (lanjutkan) {
            ...
            private static void tampilkanAlat() {
                ...
                if (dataAlat.isEmpty()) {
                    ...
                    System.out.println("Nama Tipe      : " + dataAlat.get(i).getTipe());
         ...
         private static void updateAlat() throws IOException {
                ...
                System.out.print("Nama Alat(" + newAlat.getNama()+ ") : ");
                String nama = input.readLine();

                System.out.print("Nama Tipe (" + newAlat.getTipe()+ ") : ");
                String tipe = input.readLine();
